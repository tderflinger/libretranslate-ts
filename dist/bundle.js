...
var _LibreTranslate_apiKey, _LibreTranslate_apiEndpoint, _LibreTranslate_axiosInstance;
class LibreTranslate {
    constructor() {
        _LibreTranslate_apiKey.set(this, null);
        _LibreTranslate_apiEndpoint.set(this, null);
        _LibreTranslate_axiosInstance.set(this, void 0);
        __classPrivateFieldSet(this, _LibreTranslate_axiosInstance, axios$1.create({
            headers: {
    ...
    setApiKey(key) {
        __classPrivateFieldSet(this, _LibreTranslate_apiKey, key, "f");
    }
    setApiEndpoint(endpoint) {
        __classPrivateFieldSet(this, _LibreTranslate_apiEndpoint, endpoint, "f");
        __classPrivateFieldGet(this, _LibreTranslate_axiosInstance, "f").defaults.baseURL = endpoint;
    }
    listLanguages() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield __classPrivateFieldGet(this, _LibreTranslate_axiosInstance, "f").get("/languages");
            return result.data;
        });
    }
    detect(text) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e;
            try {
                const result = yield axios$1({
                    method: "post",
                    url: `${__classPrivateFieldGet(this, _LibreTranslate_apiEndpoint, "f")}/detect`,
                    data: {
                        q: text,
                        format: "text",
                        api_key: __classPrivateFieldGet(this, _LibreTranslate_apiKey, "f"),
                    },
                    headers: {
                        Accept: "application/json",
                    },
                ...
                const response = {
                    ...
                    language: (_a = result === null || result === void 0 ? void 0 : result.data[0]) === null || _a === void 0 ? void 0 : _a.language,
                    confidence: (_b = result === null || result === void 0 ? void 0 : result.data[0]) === null || _b === void 0 ? void 0 : _b.confidence,
                    error: (_c = result === null || result === void 0 ? void 0 : result.data) === null || _c === void 0 ? void 0 : _c.error,
                };
                return response;
            }
            catch (error) {
                const response = {
                    ...
                    language: "",
                    confidence: 0,
                    error: ((_e = (_d = error.response) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.error) || (error === null || error === void 0 ? void 0 : error.message),
                };
                return response;
            }
        });
    }
    translate(text, sourceLang, targetLang, alternatives) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e;
            try {
                const result = yield axios$1({
                    method: "post",
                    url: `${__classPrivateFieldGet(this, _LibreTranslate_apiEndpoint, "f")}/translate`,
                    data: {
                        q: text,
                        source: sourceLang,
                        target: targetLang,
                ...
                const response = {
                    status: result === null || result === void 0 ? void 0 : result.status,
                    translatedText: (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.translatedText,
                    alternatives: (_b = result === null || result === void 0 ? void 0 : result.data) === null || _b === void 0 ? void 0 : _b.alternatives,
                    error: (_c = result.data) === null || _c === void 0 ? void 0 : _c.error,
                };
                return response;
            }
            catch (error) {
